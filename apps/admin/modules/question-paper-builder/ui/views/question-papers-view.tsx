...
export const QuestionPapersView = () => {
  ...
  const { data: papers, isLoading } = useQuestionPapers({ search });
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground max-w-xs">
              Start by creating your first question paper and choosing questions
              from the bank.
            </p>
          </div>
          <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPapers.map((paper) => (
            <Card
              key={paper.id}
              className="group bg-card/30 backdrop-blur-xl border-border/50 rounded-[2rem] overflow-hidden shadow-medium transition-all hover:shadow-large hover:border-primary/20"
            >
                ...
                <div className="flex justify-between items-start">
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={
                          paper.status === "Published" ? "default" : "secondary"
                        }
