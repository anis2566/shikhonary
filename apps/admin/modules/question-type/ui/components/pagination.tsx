      ...
      <div className="flex items-center gap-1">
        ...
        <div className="flex items-center gap-1 mx-2">
          <span className="text-sm text-muted-foreground">
            Page {filters.page} of {Math.ceil(totalItem / (filters.limit ?? 10))}
          </span>
        </div>
        ...
        <Button
          ...
          className="h-8 w-8"
          onClick={() => setFilters({ ...filters, page: (filters.page ?? 1) + 1 })}
          disabled={filters.page === Math.ceil(totalItem / (filters.limit ?? 10))}
        >
        ...
        <Button
          ...
          onClick={() =>
            setFilters({
              ...filters,
              page: Math.ceil(totalItem / (filters.limit ?? 10)),
            })
          }
          disabled={filters.page === Math.ceil(totalItem / (filters.limit ?? 10))}
        >
