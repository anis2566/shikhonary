        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48 rounded-xl shadow-ambient border-slate-100">
            <DropdownMenuItem asChild>
              <Link href={`/students/edit/${student.id}`} className="flex items-center gap-2 cursor-pointer font-medium p-3">
                <Edit size={16} className="text-emerald-600" /> Edit Profile
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem 
