    ...
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-xl border-b border-slate-100">
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-3">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="relative flex-shrink-0">
            <div className="w-9 h-9 rounded-[10px] bg-primary flex items-center justify-center shadow-md shadow-primary/30 text-white">
      ...
      {debounceValue && (
        <div className="px-4 pb-3 flex items-center gap-1.5 animate-in fade-in slide-in-from-top-1 duration-200">
          ...
          <span className="inline-flex items-center gap-1 bg-primary/5 text-primary text-[11px] font-semibold px-2 py-0.5 rounded-full border border-primary/10 max-w-[160px] truncate">
            "{debounceValue}"
          </span>
        </div>
      )}
