...
interface MonthlyFeeCardProps {
  fee: MonthlyFeeWithRelations;
  index: number;
  onDelete: (id: string, name: string) => void;
}

export function MonthlyFeeCard({ fee, index, onDelete }: MonthlyFeeCardProps) {
      ...
      <div className="p-5 flex-grow">
        ...
        <div className="space-y-1 mb-4">
          ...
          <div className="flex items-center gap-2 text-slate-500">
            ...
            <span className="text-xs font-medium italic">Standard monthly rate</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-3 p-2.5 bg-slate-50/50 rounded-xl border border-slate-100/50 group-hover:bg-indigo-50/30 transition-colors duration-300">
