...
interface AdmissionFeeTableProps {
  admissionFees: AdmissionFeeWithRelations[];
  isLoading: boolean;
  onDelete: (id: string, name: string) => void;
}

export const AdmissionFeeTable = ({
  admissionFees,
  isLoading,
  onDelete,
}: AdmissionFeeTableProps) => {
  const editModal = useEditAdmissionFeeModal();
      ...
      <div className="bg-surface-container-lowest py-20 flex flex-col items-center justify-center text-center space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-500 max-w-xs mx-auto text-sm leading-relaxed">
            There are no admission fees matching your criteria. Try adjusting
