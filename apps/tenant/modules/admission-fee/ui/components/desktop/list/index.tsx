...
import { AdmissionFeeTable } from "./admission-fee-table";
import { AdmissionFeeGrid } from "./admission-fee-grid";
  ...
  return (
    <div className="hidden md:flex flex-col min-h-screen bg-surface relative isolate">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 lg:px-12 max-w-7xl relative z-10">
        <Header
          title="Admission Fee List"
          description="Manage admission fees for different academic years and classes."
        />
