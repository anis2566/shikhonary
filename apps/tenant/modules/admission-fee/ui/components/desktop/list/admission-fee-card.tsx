...
interface AdmissionFeeCardProps {
  fee: AdmissionFeeWithRelations;
  index: number;
  onDelete: (id: string, name: string) => void;
}

export function AdmissionFeeCard({ fee, index, onDelete }: AdmissionFeeCardProps) {
      ...
      <div className="p-5 flex-grow">
        ...
        <div className="space-y-1 mb-4">
          ...
          <div className="flex items-center gap-2 text-slate-500">
            ...
            <span className="text-xs font-medium italic">Standard admission rate</span>
          </div>
        </div>
