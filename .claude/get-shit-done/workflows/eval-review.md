...
```bash
AUDITOR_MODEL=$(node "C:/Users/Basic/Documents/shikhonary/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/Users/Basic/Documents/shikhonary/.claude/agents/gsd-eval-auditor.md for instructions.
