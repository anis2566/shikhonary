...
- **Global scope**: `C:/Users/Basic/Documents/shikhonary/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Basic/Documents/shikhonary/.claude/notes/`)
...
2. Glob `C:/Users/Basic/Documents/shikhonary/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Basic/Documents/shikhonary/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Basic/Documents/shikhonary/.claude/notes/` — works in any directory
